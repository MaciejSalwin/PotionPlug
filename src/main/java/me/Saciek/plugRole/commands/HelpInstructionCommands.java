...
public class HelpInstructionCommands implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("help_potion")) {
            ...
            player.sendMessage(ChatColor.DARK_AQUA + "/EndurancePotion - Gives you a potion that grants basic endurance effects, such as Speed, Regeneration, Jump a(Level 1)");
            player.sendMessage(ChatColor.RED + "COST - 32 GOLD");
            player.sendMessage(ChatColor.DARK_AQUA + "/MightyPotion - Gives you a potion that grants basic strength effects, such as FireRes, Increase_Damage and DamageRes (Level 1)");
            player.sendMessage(ChatColor.RED + "COST - 15 DIAMONDS");
